...
file_name_J = 'DQD_J='+str(Omega[0])+'a='+str(alpha)+'_T='+str(T)+'_dt='+str(dt)+\
...
# file_name_t = 'DQD_PltDat_constOm='+str(Omega[0])+'a='+str(alpha)+'_T='+str(T)+'_dt='+str(dt)+\
#     '_dkmax='+str(dkmax)+'_epsrel='+str(epsrel)+'_dur='+str(dur)+'_Time.txt'
    
# file_name_s_z = 'DQD_PltDat_constOm='+str(Omega[0])+'a='+str(alpha)+'_T='+str(T)+'_dt='+str(dt)+\
...
# Save
file_name_tME = 'DQD_PltDat_constOm='+str(Omega[0])+'a='+str(alpha)+'_T='+str(T)+'_dt='+str(dt)+\
    '_dkmax='+str(dkmax)+'_epsrel='+str(epsrel)+'_dur='+str(dur)+'_TimeME.txt'
    
file_name_s_zME = 'DQD_PltDat_constOm='+str(Omega[0])+'a='+str(alpha)+'_T='+str(T)+'_dt='+str(dt)+\
...
# Save
file_name_tME = 'DQD_PltDat_constOm='+str(Omega[1])+'a='+str(alpha)+'_T='+str(T)+'_dt='+str(dt)+\
    '_dkmax='+str(dkmax)+'_epsrel='+str(epsrel)+'_dur='+str(dur)+'_TimeME.txt'
    
file_name_s_zME = 'DQD_PltDat_constOm='+str(Omega[1])+'a='+str(alpha)+'_T='+str(T)+'_dt='+str(dt)+\
    '_dkmax='+str(dkmax)+'_epsrel='+str(epsrel)+'_dur='+str(dur)+'_S_zME.txt'
    
full_path_t = os.path.join(desired_folder_data, file_name_tME)
full_path_s_z = os.path.join(desired_folder_data, file_name_s_zME)

np.savetxt(full_path_t, tME1)
np.savetxt(full_path_s_z, s_zME1)
...
# Save
file_name_tME = 'DQD_PltDat_constOm='+str(Omega[2])+'a='+str(alpha)+'_T='+str(T)+'_dt='+str(dt)+\
    '_dkmax='+str(dkmax)+'_epsrel='+str(epsrel)+'_dur='+str(dur)+'_TimeME.txt'
    
file_name_s_zME = 'DQD_PltDat_constOm='+str(Omega[2])+'a='+str(alpha)+'_T='+str(T)+'_dt='+str(dt)+\
    '_dkmax='+str(dkmax)+'_epsrel='+str(epsrel)+'_dur='+str(dur)+'_S_zME.txt'
    
full_path_t = os.path.join(desired_folder_data, file_name_tME)
full_path_s_z = os.path.join(desired_folder_data, file_name_s_zME)

np.savetxt(full_path_t, tME2)
np.savetxt(full_path_s_z, s_zME2)
...
# # np.savetxt(full_path_t, t3)
# # np.savetxt(full_path_s_z, s_z3)
...
# Save
file_name_tME = 'DQD_PltDat_constOm='+str(Omega[3])+'a='+str(alpha)+'_T='+str(T)+'_dt='+str(dt)+\
    '_dkmax='+str(dkmax)+'_epsrel='+str(epsrel)+'_dur='+str(dur)+'_TimeME.txt'
    
file_name_s_zME = 'DQD_PltDat_constOm='+str(Omega[3])+'a='+str(alpha)+'_T='+str(T)+'_dt='+str(dt)+\
    '_dkmax='+str(dkmax)+'_epsrel='+str(epsrel)+'_dur='+str(dur)+'_S_zME.txt'
    
full_path_t = os.path.join(desired_folder_data, file_name_tME)
full_path_s_z = os.path.join(desired_folder_data, file_name_s_zME)

np.savetxt(full_path_t, tME3)
np.savetxt(full_path_s_z, s_zME3)
...
# First
# full_path_t = 'C:/Users/sony/Desktop/Project/PlotData/alpha=1_T=0_dt=0.05_dkmax=70_epsrel=1e-06_dur=1.0_Time.txt'
# full_path_s_z = 'C:/Users/sony/Desktop/Project/PlotData/alpha=1_T=0_dt=0.05_dkmax=70_epsrel=1e-06_dur=1.0_S_z.txt'
...
# tME1 = np.loadtxt(full_path_tME)
# s_zME1 = np.loadtxt(full_path_s_zME)
...
# full_path_t = 'C:/Users/sony/Desktop/Project/PlotData/PltDat_constOm=18a=1_T=0_dt=0.05_dkmax=200_epsrel=1e-06_dur=8_Time.txt'
# full_path_s_z = 'C:/Users/sony/Desktop/Project/PlotData/PltDat_constOm=18a=1_T=0_dt=0.05_dkmax=200_epsrel=1e-06_dur=8_S_z.txt'
...
# tME2 = np.loadtxt(full_path_tME)
# s_zME2 = np.loadtxt(full_path_s_zME)
...
# tME3 = np.loadtxt(full_path_tME)
# s_zME3 = np.loadtxt(full_path_s_zME)



#######################################################
# Plot TEMPO Solution
plt.plot(t0, s_z0,color='r',label=r'TEMPO $\Omega={0}$ '.format(Omega[0]))
# # take out
# plt.plot(tME0, s_zME0,color='b', label=r'QME $\Omega={0}$ '.format(Omega[0]))
