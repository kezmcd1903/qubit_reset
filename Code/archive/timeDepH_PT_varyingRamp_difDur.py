...
# Read in PT
full_path_PT = 'C:/Users/sony/Desktop/Project/process_tensor/Om_0.1t_alpha=0.001_T=0_dt=0.05_dkmax=200_epsrel=1e-06_dur=200_PT.txt'
...
plt.plot(tME1, s_zME1, label=r'QME $\gamma(t),\Omega(t)$={0}t'.format(coeff1))
plt.plot(t2, s_z2, label=r'TEMPO $\Omega(t)$={1}t'.format(alpha3,coeff2))
plt.plot(tME2, s_zME2, label=r'QME $\gamma(t),\Omega(t)$={0}t'.format(coeff2))
plt.plot(t3, s_z3, label=r'TEMPO $\Omega(t)$={1}t'.format(alpha3,coeff3))
plt.plot(tME3, s_zME3, label=r'QME $\gamma(t),\Omega(t)$={0}t'.format(coeff3))
